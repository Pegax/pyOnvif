...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-a",
        "--address",
        help="address for camera control (default: 192.68.100.30:888)",
    )
    parser.add_argument(
        "-p", "--path", help="command path (default: /onvif/device_service)"
    )
    ...
    parser.add_argument(
        ...
        "--video",
        action="store_true",
        help="Looks for available streams and opens stream in videoplayer",
    )
